...
class SpinWheelGUI(ctk.CTk):
    def __init__(self):
        ...
        self.konfetti = []
        self.spinning = False   # Lås for spinning
        ...
        # Canvas for hjulet (brukes også til konfetti)
    ...
    def tegn_hjul(self):
        ...
        # Pil øverst – helrød med tykkere outline
    ...
    def spinn_hjul(self):
        if self.spinning:
            return  # Ignorer hvis spinning allerede pågår
        if not self.navn_liste:
    ...
    def animer_konfetti(self):
        if not self.konfetti:
            # Når konfettien er helt borte, fjern vinneren
        ...
        if self.konfetti:
            ...
            # Når siste partikkel er slettet, fjern vinneren
            self.fjern_vinner_automatisk()
